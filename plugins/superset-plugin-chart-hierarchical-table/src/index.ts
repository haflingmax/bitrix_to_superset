...
const metadata = new ChartMetadata({
  ...
  category: t('Hierarchical Table'),
  canBeAnnotationTypes: ['EVENT', 'INTERVAL'],
  description: t(
    'Classic row-by-column spreadsheet like view of a dataset. Use tables to showcase a view into the underlying data or to show aggregated metrics. Make hierarchical table',
  ),
  exampleGallery: [{ url: example1 }, { url: example2 }, { url: example3 }],
  name: t('Hierarchical Table'),
  tags: [
    t('Additive'),
    t('Business'),
    t('Pattern'),
